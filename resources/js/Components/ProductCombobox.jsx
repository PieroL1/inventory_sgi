        ...
        <div ref={containerRef} className="relative">
            ...
            {selectedProduct && !open ? (
                ...
                <button
                    ...
                    className={cn(
                        "w-full flex items-center gap-3 p-3 rounded-xl border bg-white/80 backdrop-blur-sm text-left transition-all hover:border-gray-300",
                ...
                // Input de búsqueda
                <div className={cn(
                    "flex items-center gap-2 px-4 py-3 rounded-2xl border bg-white/80 backdrop-blur-sm transition-all",
                    ...
                    <input
                        ...
                        className="flex-1 bg-transparent outline-none text-sm placeholder:text-gray-400 border-none focus:ring-0"
                    />
                    {open && (
                        <button
                            type="button"
            ...
            {/* Lista desplegable */}
            {open && (
                <div className="absolute z-50 w-full mt-2 py-2 bg-white rounded-xl border border-gray-200 shadow-lg max-h-64 overflow-y-auto">
