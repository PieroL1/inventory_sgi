            ...
            header={
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500">Resumen del inventario</p>
                    </div>
                </div>
            }
        >
                            ...
                            {lowStockProducts.length === 0 ? (
                                ...
                                <div className="space-y-3">
                                    {lowStockProducts.map((product) => (
                                        <div
                                            key={product.id}
                                            className="flex items-center justify-between p-3 rounded-xl bg-gradient-to-r from-amber-50/50 to-transparent border border-amber-100/50"
                                        >
                            ...
                            {recentProducts.length === 0 ? (
                                ...
                                <div className="space-y-3">
                                    {recentProducts.map((product) => (
                                        <div
                                            key={product.id}
                                            className="flex items-center justify-between p-3 rounded-xl bg-gradient-to-r from-blue-50/50 to-transparent border border-blue-100/50"
                                        >
                                            <div className="flex-1 min-w-0">
                                                <p className="text-sm font-medium text-gray-900 truncate">{product.name}</p>
                    ...
                    <CardContent className="pt-0">
                        {topValueProducts.length === 0 ? (
                            <div className="text-center py-8">
                                ...
                                <p className="text-sm text-gray-500">No hay productos en inventario</p>
                            </div>
                        ) : (
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
                                {topValueProducts.map((product, index) => (
                                    <div
                                        key={product.id}
                                        className="relative p-4 rounded-xl bg-gradient-to-br from-gray-50 to-white border border-gray-100 hover:border-primary-200 hover:shadow-md transition-all"
                                    >
                                        ...
                                        <div className="pt-2">
                                            ...
                                            <p className="text-xs text-gray-500 mb-2">{product.stock_quantity} unidades</p>
